document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (!isValid) {
        ...
        const formAlert = contactForm.querySelector('.form-alert, .form-message');
        if (formAlert) {
          formAlert.textContent = 'Please correct the errors below and try again.';
  ...
  if (animatableElements.length > 0) {
    animatableElements.forEach(function (el, index) {
      ...
      const delay = el.dataset.delay || (index % 5) * 0;
      if (el.dataset.delay) {
  ...
  // Inject base animation styles if not already present
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '62caa075-6661-464f-9a6e-0ae412caf11f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '62caa075-6661-464f-9a6e-0ae412caf11f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '62caa075-6661-464f-9a6e-0ae412caf11f';
